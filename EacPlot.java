...
public class EacPlot extends Panel //implements Runnable
{                                          
...
//Post fault
	...
	this.setLayout(gridbag);
        constrain(this,buttonpanel,0,0,1,1,GridBagConstraints.HORIZONTAL,
		GridBagConstraints.CENTER,1.0,0.0,5,5,5,5);
        constrain(this,plotgraph,0,1,1,1,GridBagConstraints.BOTH,
...
/*       Dimension d = pane.getViewportSize();
   ...
   {
      int j=0,i=0;
      if (first)  {initiate();computeValues();first=false;}
      else {if (!done) {Graph();done=true;} }
   }
...
//          this.dispose();
   ...
   public static void main( String[] args )
	...
	System.out.println("Mode : "+appletmode);
        EacPlot eac = new EacPlot();
        Frame f = new Frame("EAC Plot");
        f.add(eac);
        f.pack();
        f.show();
     }  
